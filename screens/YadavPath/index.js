...
const YadavPath = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><ImageBackground style={styles.WxEIweAV} source={{
      ...
      }} resizeMode="cover"></ImageBackground><CheckBox style={styles.rtDeDuIz} title="Checkbox Title" checked={true}></CheckBox><CheckBox style={styles.JBaXgTSU} title="Checkbox Title" checked={true}></CheckBox><CheckBox style={styles.NmQehfMF} title="Checkbox Title" checked="f"></CheckBox><CheckBox style={styles.BtgoAGtr} title="Checkbox Title" checked={true}></CheckBox><CheckBox style={styles.OKIUtACD} title="Checkbox Title" checked="fa"></CheckBox><CheckBox style={styles.KhKrvbJj} title="Checkbox Title" checked="falkse"></CheckBox></ScrollView>
    </SafeAreaView>;
};
